...
class LoadMore extends StatefulWidget {
  ...
  static DelegateBuilder<LoadMoreTextBuilder> buildTextBuilder =
      () => DefaultLoadMoreTextBuilder.indo;
...
abstract class LoadMoreDelegate {
  ...
  Widget buildChild(LoadMoreStatus status,
      {LoadMoreTextBuilder builder = DefaultLoadMoreTextBuilder.indo});
}
...
String _buildIndoText(LoadMoreStatus status) {
  String text;
  switch (status) {
    case LoadMoreStatus.fail:
      text = "Gagal memuat, silakan klik untuk mencoba lagi";
      break;
...
class DefaultLoadMoreTextBuilder {
  static const LoadMoreTextBuilder indo = _buildIndoText;
