...
class PoliScreen extends StatefulWidget {
  ...
  PoliScreen({Key key, this.request, this.isVip}) : super(key: key);

  @override
  _PoliScreenState createState() => _PoliScreenState();
}
...
class _PoliScreenState extends State<PoliScreen>
  ...
  Widget build(BuildContext context) {
    return MVVMPage<PendaftaranPresenter, PendaftaranViewModel>(
      ...
      presenter: PendaftaranPresenter(PendaftaranViewModel(), this,
          isVip ? PendaftaranPage.POLI_UTAMA : PendaftaranPage.POLI_UMUM, null),
    );
  }
  ...
  void showPoli(PoliResponse poliResponse) {
    setState(() {
      this.poliResponse = poliResponse;
      this.poliRs = poliResponse.data;
    });
  }
}
